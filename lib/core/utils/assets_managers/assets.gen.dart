...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/patients.png
  AssetGenImage get patients =>
      const AssetGenImage('assets/icons/patients.png');
  ...
  /// List of all assets
  List<AssetGenImage> get values => [history, home, patients, settings];
}
